...
class Mpampiseho {
    constructor(canvas, opts = {}) {
        ...
        // ✅ FIX: Pre-allocated scratch array — tsy misy .slice() intsony @ flush()
...
console.log('%c⚡ RAKITRAKATRA V4.2.1 "ADY GOAVANA - PATCHED" ⚡', 'color: #00ff88; font-size: 16px; font-weight: bold');
console.log('%cWebGL2 + Vondrona (SoA) + 85 Systems — All critical bugs fixed', 'color: #00ffff; font-size: 12px');
